...
> 本文把 Cloud 补齐到 n8n Cloud 的真实形态：**控制平面 = 账户门户 + 编排 + 计费三合一**。
>
...
对齐 n8n Cloud（`app.n8n.cloud` 门户 ↔ `<slug>.app.n8n.cloud` 实例）：
...
- **门户账户自服务**（Cloud 门户，对齐 app.n8n.cloud）：
...
## 五点七、仓库分离：实例产品 ↔ Cloud 编排层（对齐 n8n 公开仓/私有云的分法）
