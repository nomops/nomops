...
export const CREDENTIAL_TYPES: CredentialTypeMeta[] = [
  ...
  },
  {
    ...
    icon: '🖥️',
    description: 'Connect to an SSH server with a password',
    fields: [
      { name: 'host', label: 'Host', type: 'text', required: true },
      { name: 'port', label: 'Port', type: 'text', default: '22', required: true },
      { name: 'username', label: 'Username', type: 'text', required: true },
      { name: 'password', label: 'Password', type: 'password', required: true },
      { name: 'hostFingerprint', label: 'Host SHA256 Fingerprint', type: 'text', hint: 'Optional host-key pin, with or without the SHA256: prefix.' },
    ],
  },
  {
    type: 'sshPrivateKey',
    ...
    icon: '🔑',
    description: 'Connect to an SSH server with a private key',
    fields: [
      { name: 'host', label: 'Host', type: 'text', required: true },
      { name: 'port', label: 'Port', type: 'text', default: '22', required: true },
      { name: 'username', label: 'Username', type: 'text', required: true },
  ...
  },
  {
    ...
    fields: [
      { name: 'host', label: 'Host', type: 'text', required: true },
      { name: 'port', label: 'Port', type: 'text', default: '465', required: true },
      { name: 'user', label: 'User', type: 'text' },
      { name: 'password', label: 'Password', type: 'password' },
      { name: 'secure', label: 'SSL/TLS', type: 'toggle', default: true },
      { name: 'disableStartTls', label: 'Disable STARTTLS', type: 'toggle', default: false },
      { name: 'allowUnauthorizedCerts', label: 'Allow Self-Signed Certificates', type: 'toggle', default: false },
  ...
  },
  {
    ...
    displayName: 'IMAP',
    icon: '📨',
    description: 'Poll a mailbox for new email',
    fields: [
      { name: 'host', label: 'Host', type: 'text', required: true },
      { name: 'port', label: 'Port', type: 'text', default: '993', required: true },
